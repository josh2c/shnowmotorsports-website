    ...
    >
      <nav className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          <a
            href="https://shnowstore.com" target="_blank" rel="noopener noreferrer"
      ...
      <div
        className={cn(
          "md:hidden fixed inset-0 top-16 bg-black/95 backdrop-blur-lg transition-all duration-500 flex flex-col items-center justify-center gap-8",
          menuOpen
      ...
      >
        <a
          ...
          className="font-[family-name:var(--font-oswald)] text-3xl font-bold tracking-widest uppercase text-white/80 hover:text-white transition-colors"
        >
          Shop
        </a>
