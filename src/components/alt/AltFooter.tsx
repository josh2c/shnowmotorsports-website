...
export default function AltFooter() {
  ...
  return (
    <footer id="contact" className="px-6 md:px-16 lg:px-24 py-24" style={{ borderTop: `1px solid ${ALT_RED}33` }}>
      <div className="flex flex-col items-center gap-10">
        {/* Brand name */}
        <p
          className="font-[family-name:var(--font-oswald)] text-3xl md:text-5xl font-bold tracking-wider uppercase"
          style={{ color: ALT_RED }}
        >
          SHNOW MOTORSPORTS
        </p>
